...
import { CharCode } from '@/base/charCode.js';
import { MarshalledId } from '@/base/static/marshallingIds.js';
import * as paths from '@/base/static/path.js';
const isWindows = typeof process === 'object' && typeof process.platform === 'string' && process.platform === 'win32';
