...
import { DisposableStore, dispose, IDisposable, isDisposable, toDisposable } from '@/base/lifecycle.js';
import { SyncDescriptor, SyncDescriptor0 } from '@/platform/instantiation/common/descriptors.js';
import { Graph } from '@/platform/instantiation/common/graph.js';
import { GetLeadingNonServiceArgs, IInstantiationService, ServiceIdentifier, ServicesAccessor, _util } from '@/platform/instantiation/common/instantiation.js';
import { ServiceCollection } from './serviceCollection.js';
import { LinkedList } from '@/base/linkList.js';
...
export class InstantiationService implements IInstantiationService {
  ...
  private _createInstance<T>(ctor: any, args: unknown[] = [], _trace: Trace): T {
    ...
    for (const dependency of serviceDependencies) {
      ...
      //   const owner = this._globalGraphImplicitDependency ?? ctor.name ?? 'anonymous';
      //   this._globalGraph.insertEdge(String(owner), String(dependency.id));
      // }
